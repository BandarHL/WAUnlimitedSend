...
@class NSString, WAContact, WAProfilePictureParallaxView, WATableSection;
@protocol WAContactDetailsViewControllerDelegate, WAVCardMessagePreviewActionDelegate;

__attribute__((visibility("hidden")))
@interface WAContactDetailsViewController : WAStaticTableViewController <WAContactCardItemTableViewCellDelegate, WAContactEditViewControllerDelegate, WAProfilePictureParallaxViewDelegate, WANewContactViewControllerDelegate, ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate, MFMessageComposeViewControllerDelegate>
{
...
- (void)contactEditControllerDidDelete:(id)arg1;
