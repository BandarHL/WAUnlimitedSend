...
@class NSArray, NSMutableArray, NSString, WAAggregateCallEvent, WABizInfoTableRow, WABizProfile, WAContact, WAMediaManager, WAProductCatalogSectionViewController, WAProductForwardingHelper, WATableRow, WATableSection;

__attribute__((visibility("hidden")))
@interface WAContactViewController : WAPictureContainerViewController <ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate, UITableViewDelegate, WAContactCardItemTableViewCellDelegate, WAContactEditViewControllerDelegate, WAShareContactViewControllerDelegate>
{
    ...
    WATableSection *_sectionBizProductCatalog;
    WATableRow *_rowBizProductCatalog;
    WAProductCatalogSectionViewController *_productCatalogSectionViewController;
...
- (void)productCatalogViewController:(id)arg1 forwardProductDescriptor:(id)arg2 image:(id)arg3;
- (void)productCatalogViewController:(id)arg1 openChatWithJID:(id)arg2 productDescriptor:(id)arg3 image:(id)arg4;
- (_Bool)productCatalogSectionViewControllerShouldRetry:(id)arg1;
- (void)productCatalogSectionViewControllerSelected:(id)arg1;
- (void)productCatalogSectionViewControllerDidLoadProducts:(id)arg1;
...
- (void)updateBizProductCatalogRow;
- (_Bool)addBizProductCatalogRowIfNeeded;
- (void)createBizProductCatalogSection;
- (void)reallyAddBizProductCatalogSection;
- (_Bool)addBizProductCatalogSectionIfNeeded;
