...
@class NSDateFormatter, NSMutableArray, NSString, NSURL, UIBarButtonItem, UIButton, UIImageView, UILabel, UINotificationFeedbackGenerator, UISearchBar, UIToolbar, UIView, UIWindow, WAAnimatedCancelLabel, WAAnimatedPttLockView, WAChatSearchPickerView, WAChatSession, WAGIFSearchManager, WAInputBarRoundButton, WAInputTextView, WAInterruptedPttRecording, WAInterruptedPttRecordingView, WALinkLabel, WAMessage, WAReplyContextView, WARichText, WAWebPageFromTextLoader, WAWebPageMediaDownloader, WAWebPageMetadata, WAWebURLPreviewView;
...
@interface WAChatMessageInputView : WADraggableInputView <WAGimmickPickerViewDelegate, WAGIFSearchManagerDelegate, WAGIFSearchViewDelegate, WAWebURLPreviewViewDelegate, WAWebPageFromTextLoaderDelegate, WAInterruptedPttRecordingViewDelegate, WAReplyContextViewDelegate, UISearchBarDelegate, WAInputTextViewDelegate>
{
    ...
    _Bool _trackingQuickReplyShortcut;
...
- (void)enumerateOccurrencesOfHumanReadableQuickReplyShortcutsInText:(id)arg1 range:(struct _NSRange)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (struct _NSRange)detectQuickReplyShortcutInText:(id)arg1 atLocation:(unsigned long long)arg2;
- (void)insertQuickReply:(id)arg1 shortcutTextRange:(struct _NSRange)arg2;
- (void)notifyDelegateDidStopEditingQuickReply;
- (void)detectQuickReplyShortcut;
