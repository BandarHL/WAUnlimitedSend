...
@class NSString, UIAlertController, UILabel, UIView, WACountryInfo, WALinkLabel, WAOverlayView, WAPhoneNumberInputView, WATableRow;
@protocol WAPhoneInputViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface WAPhoneInputViewController : WAStaticTableViewController <WACountryPickerControllerDelegate, MFMailComposeViewControllerDelegate, WAPhoneNumberTextFieldDelegate, WAVerificationLinkHandling>
{
...
- (void)setUpTableView;
- (void)viewDidLoad;
- (void)askToProceedToVerificationCodeRequestWithPossibleMigration:(_Bool)arg1;
