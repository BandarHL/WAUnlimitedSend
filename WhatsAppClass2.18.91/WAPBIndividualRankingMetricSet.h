...
@property(nonatomic) _Bool hasOutgoingGroupMention; // @dynamic hasOutgoingGroupMention;
@property(nonatomic) _Bool hasOutgoingGroupReply; // @dynamic hasOutgoingGroupReply;
...
@property(nonatomic) _Bool hasStatusRowIgnored; // @dynamic hasStatusRowIgnored;
...
@property(retain, nonatomic) WAPBRankingMetric *outgoingGroupMention; // @dynamic outgoingGroupMention;
@property(retain, nonatomic) WAPBRankingMetric *outgoingGroupReply; // @dynamic outgoingGroupReply;
...
@property(retain, nonatomic) WAPBRankingMetric *statusRowIgnored; // @dynamic statusRowIgnored;
