...
@class CLGeocoder, CLLocation, CLLocationManager, MKMapView, NSArray, NSObject, NSString, WACardNavigationController, WAFriendLocationAnnotation, WAInfoButton, WALocationData, WAMapButtonMenu, WANavigationBarTitleView, WAUserTrackingButton, _WAExpiredLiveLocationFooterView;
