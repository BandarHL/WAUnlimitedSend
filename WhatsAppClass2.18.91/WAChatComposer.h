...
@interface WAChatComposer : UINavigationController <WAGroupComposerDelegate, WASinglePersonPickerDelegate, WAContactEditViewControllerDelegate, WAParticipantPickerViewControllerDelegate, WAContactDetailsViewControllerDelegate, WANewContactViewControllerDelegate>
{
...
- (void)contactDetailsViewControllerDidDeleteContract:(id)arg1;
...
- (void)newContactControllerDidSave:(id)arg1;
