...
@class NSMapTable, NSString, UIImageView, WABubbleTextView, WAStatusHeaderView, WAStatusItem, WAStatusItemView, WAStatusProgressView, WAStatusViewerFooterView, WAStatusViewerSection;
