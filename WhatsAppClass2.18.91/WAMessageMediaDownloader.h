...
@class NSMutableDictionary, NSMutableOrderedSet, NSOperationQueue, NSString, WAMediaDownloadPolicy, WARegularMediaDownloadManager, WAStreamingMediaLoaderManager, XMPPConnection;
...
- (id)initWithChatDataStores:(id)arg1 xmppConnection:(id)arg2 streamingMediaLoaderManager:(id)arg3 mmsTaskSessionV4:(id)arg4 mmsTaskSessionV3:(id)arg5;
