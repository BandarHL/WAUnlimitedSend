...
@class NSDate, NSMutableArray, NSMutableSet, NSSet, NSUserDefaults, WABizManager, WAChatStorage, WAContactsStorage, WAProfilePictureManager, XMPPConnectionMain;
...
- (id)initWithBizManager:(id)arg1 chatStorage:(id)arg2 contactsStorage:(id)arg3 profilePictureManager:(id)arg4 userDefaults:(id)arg5 xmppConnection:(id)arg6;
