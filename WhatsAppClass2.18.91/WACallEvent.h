...
- (id)callNameForDisplayOrderedOnAddressBookAvailabilityCallerFirst:(_Bool)arg1;
@property(readonly, copy, nonatomic) NSString *callNameForDisplay;
- (id)namesForParticipants:(id)arg1;
- (id)participantsToDisplayOrderedOnAddressBookAvailabilityCallerFirst:(_Bool)arg1;
@property(readonly, copy, nonatomic) NSArray *participantsToDisplay;
- (id)filteredParticipantsOnCompletedOutcome:(id)arg1;
