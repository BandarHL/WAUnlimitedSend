...
@interface WAMediaGalleryViewController : WASavedContentBrowserChildViewController <WANavigationControllerPopToAnimating, WAMediaGalleryCellMenuDelegate, UIViewControllerPreviewingDelegate, UIGestureRecognizerDelegate>
{
