...
@class NSLayoutConstraint, NSString, NSTimer, UIButton, UILabel, UIProgressView, UIScrollView, UITextField, UIView, WAOverlayView;
...
@property(nonatomic) __weak UITextField *textFieldCode; // @synthesize textFieldCode=_textFieldCode;
