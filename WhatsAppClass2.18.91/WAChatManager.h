...
@class CLLocation, NSArray, NSDate, NSLock, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, WABizManager, WABlockedContactsList, WAContactsStorage, WADomainFrontingProviderStore, WAMediaUploader, WAMessageMediaDownloader, WAMessageNotificationCenter, WAMessagingService, WANameDirectory, WAProfilePictureManager, WASignalManager, WASyncManager, WAWebClient, XMPPConnectionMain;
...
- (void)webClient:(id)arg1 didDisableLocationSharingWithJID:(id)arg2 requestID:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)webClient:(id)arg1 didUnsubscribeFromLocationUpdatesFromJID:(id)arg2 requestID:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)webClient:(id)arg1 didSetBlockedState:(_Bool)arg2 ofUserWithJID:(id)arg3 reason:(id)arg4 requestID:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)webClient:(id)arg1 didCreateGroupWithSubject:(id)arg2 description:(id)arg3 descriptionID:(id)arg4 participants:(id)arg5 announcementOnly:(_Bool)arg6 locked:(_Bool)arg7 requestID:(id)arg8 completion:(CDUnknownBlockType)arg9;
...
- (void)webClient:(id)arg1 didDemoteAdmins:(id)arg2 inChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)webClient:(id)arg1 didPromoteParticipants:(id)arg2 inChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)webClient:(id)arg1 didAddParticipants:(id)arg2 inChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)webClient:(id)arg1 didRemoveParticipants:(id)arg2 inChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)webClient:(id)arg1 didDeletePictureForChatWithJID:(id)arg2 requestID:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)webClient:(id)arg1 didSetPicture:(id)arg2 forChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)webClient:(id)arg1 didSetSpamStatus:(_Bool)arg2 ofChatWithJID:(id)arg3 requestID:(id)arg4 completion:(CDUnknownBlockType)arg5;
