...
@class NSArray, NSLayoutConstraint, NSMutableDictionary, NSString, UIFont, UIView, WAContactsSection, WASearchResultsController, WATableSection;
@protocol WASinglePersonPickerDelegate;

__attribute__((visibility("hidden")))
@interface WASinglePersonPicker : WATableViewController <WASearchControllerDelegate, WASearchResultsControllerDelegate, WAContactTableViewCellDelegate, MFMessageComposeViewControllerDelegate>
{
