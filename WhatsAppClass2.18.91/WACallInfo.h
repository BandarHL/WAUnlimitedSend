...
@property(readonly, nonatomic) int bytesReceived; // @synthesize bytesReceived=_bytesReceived;
@property(readonly, nonatomic) int bytesSent; // @synthesize bytesSent=_bytesSent;
...
@property(readonly, nonatomic) NSString *creatorJID; // @synthesize creatorJID=_creatorJID;
