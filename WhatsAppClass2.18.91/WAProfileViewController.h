...
@class NSString, UIImage, WAEditProfilePhotoHelper, WAGroupIconViewController, WAProfileHeaderTableViewCell, WAProgressAlertController, WATableRow, WATableSection;
...
@interface WAProfileViewController : WAStaticTableViewController <WASinglePhotoPickerControllerDelegate, WANavigationControllerPopToAnimating, WAEditProfilePhotoHelperDelegate>
{
    ...
    WAProgressAlertController *_smbProgressController;
}

@property(retain, nonatomic) WAProgressAlertController *smbProgressController; // @synthesize smbProgressController=_smbProgressController;
...
- (void)finishConsumerProfileEditing;
