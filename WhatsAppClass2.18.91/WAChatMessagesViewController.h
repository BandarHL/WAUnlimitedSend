...
@class NSArray, NSMutableArray, NSNumber, NSSet, NSString, UIBarButtonItem, UIToolbar, UIView, WAChatCellData, WAChatMessagesController, WAChatMessagesTableView, WAMessage, WAMessageBubbleTableViewCell, WAMessagePresenterHelper, WAPaymentCoordinator, WAReportSpamCell, WAVCardMatchCell, WAWallpaperView;
@protocol WABlurredBackgroundProviding;

__attribute__((visibility("hidden")))
@interface WAChatMessagesViewController : WAViewController <ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, WAContactEditViewControllerDelegate, EKEventEditViewDelegate, WAMessageBubbleTableViewCellDelegate, WAChatMessagesControllerDelegate, WAPaymentCoordinatorDelegate, UIViewControllerPreviewingDelegate, WATableViewCellPreviewingDelegate, WAVCardMessagePreviewActionDelegate, WANavigationControllerPopToAnimating, WAChatMessagesTableViewDelegate>
{
...
- (void)viewMoreForMessage:(id)arg1;
...
- (_Bool)shouldAllowViewMoreInMessage:(id)arg1;
...
- (void)startNewPaymentFlowForHandle:(id)arg1;
- (void)startPaymentFlowWithConfiguration:(id)arg1;
