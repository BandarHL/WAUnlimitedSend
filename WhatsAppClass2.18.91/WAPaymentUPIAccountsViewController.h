...
@class NSArray, NSIndexPath, NSString, UIBarButtonItem, WAActivityLabel, WAPaymentsProcessedByFooterView, WAViewControllerConnectionObserver, _WAPaymentUPIAccountsTableHeaderView;
