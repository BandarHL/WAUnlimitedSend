...
@class NSArray, NSDictionary, NSMutableArray, NSMutableIndexSet, NSString, NSURL, UIImageView, UIImpactFeedbackGenerator, UITapGestureRecognizer, UIView, WACaptionBar, WAChatSession, WAFilterHintView, WAFilterPreviewView, WAFilterTemplateStripView, WAImageToImagePanPopGestureRecognizer, WAMediaFilterRenderer, WAMediaPickerLibraryController, WAMediaPickerStats, WAMentionsSelectorView, WAMultiSendHeaderView, WAMultiSendMediaItemQuality, WAMultiSendMediaSendProcessor, WAMultiSendRevealFiltersGestureRecognizer, WAMultiSendThumbnailBrowserView, WAPageableItemBrowserView, WAPaintCanvasDevice, WAStatusComposerNUX, WamEventMediaPickerPerf;
@protocol WAMultiSendPreviewViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface WAMultiSendPreviewViewController : WAViewController <WACaptionBarDelegate, WAMentionsSelectorViewDelegate, WAFilterPreviewViewDelegate, WAFilterTemplateStripViewDelegate, WAFilterTemplateStripViewDataSource, WAMediaPickerControllerDelegate, WACameraViewControllerDelegate, WAPageableItemBrowserViewDelegate, WAMultiSendThumbnailBrowserViewDelegate, WAMultiSendHeaderViewDelegate, UIGestureRecognizerDelegate, WAPaintCanvasTextureManagerImageDataSource, WAStatusComposerNUXDelegate, WAMultiSendMediaSendProcessorDelegate, WAImageToImagePanPopGestureRecognizerDelegate, WANavigationControllerPopFromAnimating>
{
