...
@class NSString, WAAssetManager, WAAssetMetadataManager, WACertPinning, WAPersistentKeyValueStore;
...
- (void)dealloc;
- (id)initWithLocalKeyValueStore:(id)arg1 pinnedCertificate:(id)arg2;
