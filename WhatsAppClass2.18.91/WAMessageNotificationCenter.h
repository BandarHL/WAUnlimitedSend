...
@class AVAudioPlayer, CTCallCenter, NSArray, NSManagedObjectContext, NSMutableArray, NSMutableDictionary, NSString, WAChatStorage, WANotificationWindow, WAPushSound, WASoundEffect, XMPPConnectionMain;
...
@interface WAMessageNotificationCenter : NSObject <WANotificationWindowDelegate>
{
    ...
    NSManagedObjectContext *_customConfigsContext;
...
- (void)scheduleNotificationForMessage:(id)arg1 fromSenderName:(id)arg2;
...
- (void)saveCustomConfigsContext;
- (void)withCustomConfigsContextPerformBlockAndWait:(CDUnknownBlockType)arg1;
- (id)customConfigsContext;
