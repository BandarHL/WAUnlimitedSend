...
@interface WALiveLocationTableViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDelegate, WACaptionBarDelegate, WAMentionsSelectorViewDelegate, WAAutoCompleteSelectorViewDelegate>
{
