...
@interface WAMediaBrowserViewController : WAViewController <UICollectionViewDataSource, UICollectionViewDelegate, WACalloutViewPresenterDelegate, WAMediaBrowserCollectionViewCellDelegate, WAMediaBrowserVideoCellDelegate, WAMediaBrowserToolbarDelegate, WANoOpGestureRecognizerTouchDelegate, WANavigationControllerPopFromAnimating, WAImageToImageTransitioning, WAImageToImagePanPopGestureRecognizerDelegate>
{
...
- (void)mediaBrowserCollectionViewCell:(id)arg1 didSelectInteractiveAnnotation:(id)arg2 inInteractiveAnnotationView:(id)arg3;
