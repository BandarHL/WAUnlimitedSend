...
- (id)initWithCurrency:(id)arg1 amount_1000:(long long)arg2 credentialId:(id)arg3 deviceId:(id)arg4 encryptedMpin:(id)arg5 receiverHandle:(id)arg6 clTransactionId:(id)arg7 merchantCode:(id)arg8 refId:(id)arg9 refUrl:(id)arg10 note:(id)arg11 payeeName:(id)arg12;
