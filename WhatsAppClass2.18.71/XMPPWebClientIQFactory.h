...
+ (id)callQueryResponseWithCode:(long long)arg1 extraElements:(id)arg2 requestID:(id)arg3 forWebSession:(id)arg4;
...
+ (id)updateChatSession:(id)arg1 forWebSession:(id)arg2;
...
+ (id)notificationQueryResponseWithErrorCode:(long long)arg1 token:(id)arg2 requestID:(id)arg3;
+ (id)notificationQueryResponseWithMessages:(id)arg1 messageCount:(unsigned long long)arg2 unreadChats:(unsigned long long)arg3 token:(id)arg4 requestID:(id)arg5 forWebSession:(id)arg6;
+ (id)actionQueryResponseWithItems:(id)arg1 replaced:(_Bool)arg2 requestID:(id)arg3 forWebSession:(id)arg4;
