...
+ (void)setupUserInfoForRequest:(id)arg1 messages:(id)arg2 mediaKey:(id)arg3 reuploading:(_Bool)arg4 asyncResumeCheckResult:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)needUploadReadyAssetFromAsset:(id)arg1 mediaKeyDataForReuse:(id)arg2 skipMediaKeyReuse:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)startOptimisticMediaUploadForFile:(id)arg1 mediaType:(unsigned long long)arg2 mimeType:(id)arg3 identifier:(id)arg4 cellularAllowed:(_Bool)arg5 skipResumeCheck:(_Bool)arg6 isForward:(_Bool)arg7 delegate:(id)arg8;
- (float)progressOfMediaUploadForMessage:(id)arg1;
- (void)fetchMostRecentItemForReuseWithPlaintextFileHash:(id)arg1 mediaKeyData:(out id *)arg2 mediaFilePath:(out id *)arg3 asyncResumeCheckResult:(out id *)arg4;
...
- (id)startOptimisticExistCheckForFile:(id)arg1 mediaType:(unsigned long long)arg2 mimeType:(id)arg3 identifier:(id)arg4;
- (id)startOptimisticMediaUploadForFile:(id)arg1 mediaType:(unsigned long long)arg2 mimeType:(id)arg3 identifier:(id)arg4 cellularAllowed:(_Bool)arg5 skipResumeCheck:(_Bool)arg6 isForward:(_Bool)arg7;
