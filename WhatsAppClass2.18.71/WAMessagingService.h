...
@class NSMutableDictionary, NSString, WABackgroundConnectionAvailableNotifier, WAExactTimer, WAMediaUploader, WAPersistentKeyValueStore, WASignalManager, XMPPConnection;
...
- (void)reportFieldStatsForSentMessageAttempt:(id)arg1 result:(long long)arg2 participant:(id)arg3;
