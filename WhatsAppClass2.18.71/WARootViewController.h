...
#import "WAVerificationControllerDelegate-Protocol.h"
...
@interface WARootViewController : WAViewController <WARestoreBackupViewControllerDelegate, UITabBarControllerDelegate, WAVerificationControllerDelegate, WAChatDatabaseMigrationViewControllerDelegate, WAGroupInviteJoinControllerDelegate, WARepairDatabaseControllerDelegate, WATOSViewControllerDelegate, WAWindowController>
{
...
- (void)setNeedsProcessInteropUPIPaymentRequest:(id)arg1;
