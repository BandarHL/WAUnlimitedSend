...
@interface WAStatusDownloadableItemView : WAStatusItemView <UIScrollViewDelegate, UIGestureRecognizerDelegate, WANoOpGestureRecognizerTouchDelegate, WAMediaTransferProgressViewDelegate>
{
