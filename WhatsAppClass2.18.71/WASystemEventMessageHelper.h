...
+ (id)localizedEventDescriptionForMessage:(id)arg1 withAction:(_Bool)arg2 verifiedBadgePlaceholder:(id)arg3;
+ (id)localizedEventDescriptionForMessage:(id)arg1;
+ (id)stringComponentsForExportForMessage:(id)arg1 withSenderName:(_Bool)arg2;
+ (id)stringRepresentationForChatForMessage:(id)arg1 witAction:(_Bool)arg2;
