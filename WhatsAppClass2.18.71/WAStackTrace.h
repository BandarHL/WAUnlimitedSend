...
+ (_Bool)uploadCriticalEventWithName:(id)arg1 addresses:(id)arg2 symbols:(id)arg3 forPreviousLaunch:(_Bool)arg4 previousStackTrace:(id)arg5 attachmentPath:(id)arg6 discretionary:(_Bool)arg7 samplingRate:(id)arg8;
...
+ (void)markLogAsCriticalEventAtPath:(id)arg1 attachmentPath:(id)arg2 shouldForceUpload:(_Bool)arg3;
