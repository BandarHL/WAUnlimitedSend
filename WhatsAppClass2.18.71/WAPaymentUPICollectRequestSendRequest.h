...
- (id)initWithCurrency:(id)arg1 amount_1000:(long long)arg2 deviceId:(id)arg3 senderHandle:(id)arg4 clTransactionId:(id)arg5 credentialId:(id)arg6 note:(id)arg7;
