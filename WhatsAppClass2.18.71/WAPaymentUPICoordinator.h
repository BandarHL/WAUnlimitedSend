...
@class NSArray, NSDictionary, NSError, NSMutableOrderedSet, NSString, UIViewController, WAConnectionObserver, WAMessage, WAModalNavigationController, WAPaymentManager, WAPaymentUPIBankAccount, WAPaymentUPIPSPConfiguration, WAPaymentUPIPayRequest, WAProgressAlertController, XMPPUPIBankResponse;
@protocol WAPaymentUPICoordinatorDelegate, WAViewControllerExtensions;

__attribute__((visibility("hidden")))
@interface WAPaymentUPICoordinator : NSObject <MFMessageComposeViewControllerDelegate>
{
...
@property(readonly, nonatomic) WAPaymentUPIPayRequest *paymentRequest; // @synthesize paymentRequest=_paymentRequest;
...
- (void)startPaymentFlowForAccount:(id)arg1 paymentRequest:(id)arg2 fromViewController:(id)arg3;
...
- (id)initWithPaymentManager:(id)arg1 delegate:(id)arg2;
- (void)resetDataForCL;
- (void)loadDataForCL;
...
- (void)paymentSendViewController:(id)arg1 didRequestToChooseAccountWithRequest:(id)arg2;
- (void)paymentSendViewController:(id)arg1 didRequestToChoosePayeeWithRequest:(id)arg2;
- (void)paymentSendViewController:(id)arg1 didConfirmPaymentRequest:(id)arg2;
...
- (void)showPaymentRequestTypeConfirmationForResponse:(id)arg1;
