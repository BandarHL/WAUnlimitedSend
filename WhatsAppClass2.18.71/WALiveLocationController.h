...
@class CLLocation, NSDate, NSMutableDictionary, NSMutableSet, NSString, NSTimer, WALiveLocationReportingSession, WALocationSource, WALocationSubscription, WARateLimitedOperation, WARollingWindow, WAWeakTimer, XMPPConnection, XMPPNotificationStanza;

__attribute__((visibility("hidden")))
@interface WALiveLocationController : WAChatDataStoreCoordinator <CLLocationManagerDelegate, WALocationSourceDelegate, WAPersistentRequestManagerRegistering>
{
...
- (void)sendFinalLocationRetryResponseNotificationToParticipant:(id)arg1 encryptResult:(id)arg2 chatJID:(id)arg3 messageID:(id)arg4 retryCount:(long long)arg5;
- (void)sendFinalRetryForParticipant:(id)arg1 forChat:(id)arg2 messageID:(id)arg3 retryCount:(unsigned long long)arg4;
- (id)finalLocationForMessageID:(id)arg1 inChat:(id)arg2 isFromMe:(_Bool)arg3;
...
- (void)sendRetryDenyToParticipant:(id)arg1 chatJID:(id)arg2 messageID:(id)arg3;
...
- (id)finalLocationNotificationWithCiphertextStanza:(id)arg1 chatJID:(id)arg2 messageID:(id)arg3;
...
- (void)handleFinalLocationUpdateRetryDeny:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)reportLocation:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)handleLocationUpdate:(id)arg1 from:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)didReceiveScheduledPushForChat:(id)arg1;
