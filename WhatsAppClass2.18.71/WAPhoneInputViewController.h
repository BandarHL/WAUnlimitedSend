...
@class NSString, UILabel, UIView, WACountryInfo, WALinkLabel, WAOverlayView, WAPhoneNumberInputView, WATableRow;
@protocol WAPhoneInputViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface WAPhoneInputViewController : WAStaticTableViewController <WACountryPickerControllerDelegate, MFMailComposeViewControllerDelegate, WAPhoneNumberTextFieldDelegate, WALinkLabelDelegate, WAVerificationLinkHandling>
{
