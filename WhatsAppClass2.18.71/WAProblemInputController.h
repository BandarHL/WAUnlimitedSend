...
@class NSArray, NSObject, NSString, ProblemInputControllerConfiguration, UIBarButtonItem, UIImage, UITableViewCell, UITapGestureRecognizer, UITextView, UIView, WADoneWithSpinnerBarButtonItem, WAHTTPFetcher, WAImageAttachmentContainerView;
@protocol OS_dispatch_group, WAProblemInputControllerBottomView, WAProblemInputControllerDelegate;

__attribute__((visibility("hidden")))
@interface WAProblemInputController : WATableViewController <WAImageAttachmentContainerViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIGestureRecognizerDelegate, WAFAQBrowserViewControllerDelegate, UITextViewDelegate>
{
