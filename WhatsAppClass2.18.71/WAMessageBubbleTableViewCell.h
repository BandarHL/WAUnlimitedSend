...
@class NSArray, NSSet, NSString, UIButton, UIPanGestureRecognizer, UIView, UIViewController, WAChatCellData, WAMessage, WAMessageBubbleAlertButton, WAMessageBubbleForwardButton, WAMessageContainerView;
...
- (void)messageContainerView:(id)arg1 didReceiveLongPressAtPoint:(struct CGPoint)arg2 forMessage:(id)arg3;
